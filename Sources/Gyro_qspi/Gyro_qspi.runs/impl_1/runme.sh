...
HD_PWD='D:/verilog/Gyro_qspi/Gyro_qspi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gyro_Demo.tcl -notrace
