...
HD_PWD='D:/verilog/Gyro_qspi/Gyro_qspi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gyro_Demo.tcl
